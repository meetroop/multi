...
public class CreateSQLiteDB {
    public static void main(String[] args) {
        String databaseFilePath = "your_database.db"; // Replace this with the desired path to the database file.

        try {
            // Step 1: Register the SQLite JDBC driver (you need to have the JDBC driver JAR in your classpath)
            Class.forName("org.sqlite.JDBC");

            // Step 2: Create a connection to the database (If the database doesn't exist, it will be created)
